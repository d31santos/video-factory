# QA Report — demo-003 (mode B, vertical)

Video: `out/demo-003.mp4` — validated by scripts/validate_output.sh (qa/demo-003/validate.json).

| Rule | Verdict | Evidence |
|------|---------|----------|
| R1 resolution/fps/codec per format | PASS | validate.json rules.R1 (vertical) |
| R2 duration in range | PASS | validate.json duration_s=43.882667 |
...
Frames: qa/demo-003/frame_*.png. Descript: qa/demo-003/descript.md. Scores: qa/demo-003/opusclip.md.
