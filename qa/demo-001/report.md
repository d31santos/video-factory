# QA Report — demo-001 (mode B, vertical)

Video: `out/demo-001.mp4` — validated by scripts/validate_output.sh (qa/demo-001/validate.json).

| Rule | Verdict | Evidence |
|------|---------|----------|
| R1 resolution/fps/codec per format | PASS | validate.json rules.R1 (vertical) |
| R2 duration in range | PASS | validate.json duration_s=50.048000 |
...
Frames: qa/demo-001/frame_*.png. Descript: qa/demo-001/descript.md. Scores: qa/demo-001/opusclip.md.
