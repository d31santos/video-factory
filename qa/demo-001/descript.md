...
- Voice: edge-tts (en-US-AriaNeural) — Descript AI voice not used in the deterministic path.
...
- Cleanup instruction for the real path: "Remove filler words and awkward silences. Improve audio quality. Do not cut any sentence content."
